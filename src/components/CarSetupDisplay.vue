                ...
                <v-card-text>
                  ...
                  <v-row>
                    ...
                    <v-col cols="6">
                      ...
                      <v-slider
                        v-model="carSetup.m_offThrottle"
                        :min="0"
                        :max="100"
                        readonly
                        density="comfortable"
...
import { storeToRefs } from 'pinia';
  ...
  const { carSetup } = storeToRefs(store);
  </script>
